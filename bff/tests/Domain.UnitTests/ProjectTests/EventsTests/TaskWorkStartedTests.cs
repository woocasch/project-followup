...
public sealed class TaskWorkStartedTests
{
    private TaskWorkStarted instance;
    ...
    public void WhenInstanceIsSerializedThenSerializedInstanceIsAsExpected()
    {
        ...
        var testInstance = new TaskWorkStarted(
            ProjectId.FromGuid(projectIdValue),
            taskIdValue,
            new DateTimeOffset(2025, 4, 5, 6, 7, 8, TimeSpan.Zero));
        var expectedSerializedValue = """{"projectId":"e3e77038-be0a-4080-b851-daa7c52db072","taskId":"a1b2c3d4-e5f6-4a5b-8c9d-0e1f2a3b4c5d","startedAt":"2025-04-05T06:07:08+00:00"}""";
    ...
    {
        var serializedValue = """{"projectId":"0a4afa70-8683-4276-8173-4f456c673e83","taskId":"f1e2d3c4-b5a6-4c5d-8e9f-0a1b2c3d4e5f","startedAt":"2026-07-08T09:10:11+00:00"}""";
        var expectedInstance = new TaskWorkStarted(
    ...
    private void InstanceIsSetTo(TaskWorkStarted value) => this.instance = value;
    ...
    {
        this.instance = this.serializedInstance.Deserialize<TaskWorkStarted>();
    }

    private void InstanceIs(TaskWorkStarted value)
    {
