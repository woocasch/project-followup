...
public sealed class ProjectIdTests
{
    ...
    public void WhenInstanceIsSerializedThenSerializedValueIsCorrect()
    {
        ...
        var testInstance = ProjectId.FromGuid(idValue);
        var expectedSerializedValue = $"\"{idValue}\"";
        this.Given(t => t.ProjectIdIsSetTo(testInstance))
    ...
    public void WhenInstanceIsDeserializedThenInstanceIsCorrect()
    {
        ...
        var expectedInstance = ProjectId.FromGuid(idValue);
    ...
    private void ProjectIdIsSetTo(ProjectId value) => this.instance = value;
    ...
    {
        this.instance = this.serializedValue.Deserialize<ProjectId>()!;
    }

    private void InstanceIs(ProjectId expected)
    {
